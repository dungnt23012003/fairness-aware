...
# saIndex: index number of protected attribute in feature list
# saValue
...
def calculate_performance_equalized_odds(data, labels, predictions, saIndex, saValue):
    protected_pos = 0.
    protected_neg = 0.
    non_protected_pos = 0.
    non_protected_neg = 0.
...
def plot_my_resultsEQOP(results, names, output_dir, dataset):
    ...
    plt.xticks(index + 1.5 * bar_width,
               ('Accuracy', 'Balanced Accuracy', 'Equal Opportunity', 'TPR Prot.', 'TPR Non-Prot.', 'TNR Prot.',
                'TNR Non-Prot.'))
...
def plot_my_results_from_list_sp(dataset):
    ...
    if dataset == 'adult-gender':
        ...
        std_balanced_accuracy_list = [0.0034165442777111987, 0.0024571762875774377, 0.0020128690181906088,
                                      0.0032339196570538185]
        ...
        std_tpr_protected_list = [0.0037548904955061178, 0.0323677711507874, 0.0063990508875998017,
                                  0.020030758560065903]
        tpr_non_protected_list = [0.26229230789830504, 0.3692727213870132, 0.46656418817474893, 0.25609558609262623]
        std_tpr_non_protected_list = [0.0055284524593893344, 0.029249663940729944, 0.010109904658918398,
                                      0.0084334762746968907]
        tnr_protected_list = [0.94036485545336868, 0.6298253623780032, 0.88914450187568783, 0.74710324249465243]
        std_tnr_protected_list = [0.0037548904955061308, 0.03236777115078741, 0.0063990508875998182,
                                  0.02003075856006592]
        tnr_non_protected_list = [0.73770769210169507, 0.6307272786129867, 0.53343581182525102, 0.74390441390737383]
        std_tnr_non_protected_list = [0.0055284524593893127, 0.029249663940729934, 0.0101099046589184,
                                      0.0084334762746968942]
        ...
        std_tnr_non_protected_list = [0.04284733779303078, 0.05910951434609069, 0.02799381965088921,
                                      0.03828690920323129]
        ...
        std_balanced_accuracy_list = [0.0049149868796822442, 0.008853446174547372, 0.0069193678371777517,
                                      0.010500225706748996]
        ...
        std_tpr_protected_list = [0.0023387056304894805, 0.006726767823488218, 0.0076966352989901619,
                                  0.01234879957535282]
        tpr_non_protected_list = [0.093851855642511126, 0.10993577711975958, 0.22763009100877682, 0.093302239414308277]
        std_tpr_non_protected_list = [0.0032120931541992619, 0.005594537382633125, 0.015127999360102978,
                                      0.0073548140987078686]
        tnr_protected_list = [0.94784009339970388, 0.8928781824706886, 0.86203069195575088, 0.90567847680065672]
        std_tnr_protected_list = [0.0023387056304894653, 0.006726767823488231, 0.007696635298990181,
                                  0.012348799575352823]
        tnr_non_protected_list = [0.90614814435748881, 0.8900642228802405, 0.77236990899122326, 0.90669776058569163]
        std_tnr_non_protected_list = [0.0032120931541992619, 0.00559453738263314, 0.015127999360102992,
                                      0.0073548140987078686]
    elif dataset == 'kdd':
        ...
        std_balanced_accuracy_list = [0.0028052829061364568, 0.00901769434497467, 0.0047564858286854323,
                                      0.017238385852276938]
        ...
        std_tpr_protected_list = [0.00033560066736028452, 0.004329087764614954, 0.0016359101969885092,
                                  0.068341732220019519]
        tpr_non_protected_list = [0.057401514981443115, 0.09008682248694556, 0.11424947613562689, 0.059031899618100805]
        std_tpr_non_protected_list = [0.0017738264522089721, 0.0046730753826213535, 0.0031806117445401889,
                                      0.0016631601051075779]
        tnr_protected_list = [0.99460302635496434, 0.9112347045992503, 0.98078852576949715, 0.92997502023711365]
        std_tnr_protected_list = [0.00033560066736028522, 0.004329087764614965, 0.0016359101969884921,
                                  0.068341732220019533]
        tnr_non_protected_list = [0.94259848501855692, 0.9099131775130544, 0.88575052386437325, 0.94096810038189904]
        std_tnr_non_protected_list = [0.0017738264522089895, 0.004673075382621363, 0.0031806117445401707,
                                      0.0016631601051075957]
    ...
    plt.xticks(index + 1.5 * bar_width,
               ('Accuracy', 'Bal. Acc.', 'St.Parity', 'Prot. Pos.', 'Non-Prot. Pos.', 'Prot. Neg.', 'Non-Prot. Neg.'))

    colors = ["#B0B0B0", "#E74C3C", "#3498DB", "#2ECC71"]
    # for i in range(0, len(names)):
    plt.bar(index + bar_width * 0,
            [accuracy_list[3], balanced_accuracy_list[3], fairness_list[3], tpr_protected_list[3],
             tpr_non_protected_list[3], tnr_protected_list[3], tnr_non_protected_list[3]], bar_width,
            yerr=[std_accuracy_list[3], std_balanced_accuracy_list[3], std_fairness_list[3], std_tpr_protected_list[3],
                  std_tpr_non_protected_list[3], std_tnr_protected_list[3],
                  std_tnr_non_protected_list[3]], label=names[3], color=colors[2], edgecolor='black')

    plt.bar(index + bar_width * 1,
            [accuracy_list[0], balanced_accuracy_list[0], fairness_list[0], tpr_protected_list[0],
             tpr_non_protected_list[0], tnr_protected_list[0], tnr_non_protected_list[0]], bar_width,
            yerr=[std_accuracy_list[0], std_balanced_accuracy_list[0], std_fairness_list[0], std_tpr_protected_list[0],
                  std_tpr_non_protected_list[1], std_tnr_protected_list[0],
                  std_tnr_non_protected_list[0]], label=names[0], color=colors[0], edgecolor='black')

    plt.bar(index + bar_width * 2,
            [accuracy_list[2], balanced_accuracy_list[2], fairness_list[2], tpr_protected_list[2],
             tpr_non_protected_list[2], tnr_protected_list[2], tnr_non_protected_list[2]], bar_width,
            yerr=[std_accuracy_list[2], std_balanced_accuracy_list[2], std_fairness_list[2], std_tpr_protected_list[2],
                  std_tpr_non_protected_list[2], std_tnr_protected_list[2],
                  std_tnr_non_protected_list[2]], label=names[2], color=colors[1], edgecolor='black')

    plt.bar(index + bar_width * 3,
            [accuracy_list[1], balanced_accuracy_list[1], fairness_list[1], tpr_protected_list[1],
             tpr_non_protected_list[1], tnr_protected_list[1], tnr_non_protected_list[1]], bar_width,
            yerr=[std_accuracy_list[1], std_balanced_accuracy_list[1], std_fairness_list[1], std_tpr_protected_list[1],
                  std_tpr_non_protected_list[1], std_tnr_protected_list[1],
...
def plot_my_results_from_list_eqop(dataset):
    ...
    if dataset == 'adult-gender':
        ...
        std_balanced_accuracy_list = [0.0034165442777111987, 00.002835221496869, 0.0017686647761703674,
                                      0.002826012688138698]
        ...
        std_tpr_non_protected_list = [0.0096463265823206277, .02743501031574507302, 0.0087798744757660308,
                                      0.027276438672765704]
        ...
        std_tnr_non_protected_list = [0.0051467651774054603, 00.0317936763847606195, 0.010260785062740344,
                                      0.027085604926498946]
    elif dataset == 'compass-gender':
        ...
        std_balanced_accuracy_list = [0.00782117593313684, 0.0150174663251441657, 0.009502593227186553,
                                      0.010465191868153471]
        ...
        std_tnr_non_protected_list = [0.046849064790145126, 0.085651285287601484, 0.0381608182174372,
                                      0.07623538135080789]
    elif dataset == 'bank':
        ...
        std_balanced_accuracy_list = [0.0049149868796822442, 0.021187025211562281, 0.0050568728357864683,
                                      0.00532987182467402]
        ...
        std_tpr_protected_list = [0.014701760130666241, 0.069791705499161388, 0.016088669221312787,
                                  0.014143152400590156]
        tpr_non_protected_list = [0.40052713669989998, 0.6599, 0.74614153412646789, 0.816543043101094]
        std_tpr_non_protected_list = [0.013184925292930135, 0.07352417411490916702, 0.031227957465693647,
                                      0.00533287645748039]
        ...
        std_accuracy_list = [0.0003205607874917051, 0.0123120237980150084309, 0.00072928745870637574,
                             0.017381877219775286]
        balanced_accuracy_list = [0.67010511019216046, 0.84039189925026559, 0.76862451179642632, 0.8309845441564062]
        std_balanced_accuracy_list = [0.0028052829061364568, 0.0106182017362436847, 0.004180099571768083,
                                      0.005019994609921996]
        ...
        std_tpr_protected_list = [0.0060130875772270043, 0.038543168206689258, 0.014749705252314315,
                                  0.014196401225727207]
        tpr_non_protected_list = [0.40836190539916384, 0.77352144507729271, 0.6383875406492997, 0.89639924390503]
        std_tpr_non_protected_list = [0.0084998153592860202, 0.036446819123051484, 0.010881377126951641,
                                      0.012723612525953913]
        tnr_protected_list = [0.9979799508908197, 0.91543278365979992, 0.98779847070972671, 0.7696201902968531]
        std_tnr_protected_list = [0.00027043660848440748, 0.0123189966275389258, 0.0010913981570608276,
                                  0.024717910290754954]
        tnr_non_protected_list = [0.98243238104616726, 0.902642894824884225, 0.94535996657650789, 0.7663731181929454]
        std_tnr_non_protected_list = [0.0012111197845660435, 0.01673489204307783, 0.0020289538389142094,
                                      0.014998042842229355]
    ...
    plt.xticks(index + 1.5 * bar_width,
               ('Accuracy', 'Bal. Acc.', 'Eq. Op.', 'TPR Prot.', 'TPR Non-Prot.', 'TNR Prot.', 'TNR Non-Prot.'))
...
def plot_my_results_from_list_dm(dataset):
    ...
    if dataset == 'adult-gender':
        accuracy_list = [0.84125730476359129, 0.83616398087480067, 0.849160014166814243, 0.8118909107008456,
                         0.837750132]
        std_accuracy_list = [0.0021313582417819251, 0.0025664235520122067, 0.0017303235479497101, 0.0071879299630220608,
                             0.0172310617]
        balanced_accuracy_list = [0.70581541065707015, 0.70324222501649845, 0.72621455272353227, 0.8023158733406547,
                                  0.79465430]
        std_balanced_accuracy_list = [0.0034165442777111987, 0.005405353108096869, 0.0017686647761703674,
                                      0.02826012688138698, 0.016171962]
        fairness_list = [0.131235516797286589, 0.061278466419440502, 0.23200711712535602, 0.4720733687320755933,
                         0.07795596]
        std_fairness_list = [0.010051804326223008, 0.011404127853139124, 0.031476138004416419, 0.034441999118292375,
                             0.021959274]
        tpr_protected_list = [0.56238015524640588, 0.44872371754247998, 0.362377106310226216, 0.60023359117813,
                              0.73949702395]
        std_tpr_protected_list = [0.026993921544918097, 0.044443064351168614, 0.040470375545631919,
                                  0.025738981830001263, 0.086285605]
        tpr_non_protected_list = [0.44473532321927183, 0.50457550645302358, 0.5357781802276182, 0.8145630805321845,
                                  0.703974812]
        std_tpr_non_protected_list = [0.016463265823206277, 0.051177514224507302, 0.0117798744757660308,
                                      0.00827276438672765704, 0.07745906]
        tnr_protected_list = [0.97796080170609046, 0.94624364036822376, 0.994724707529353714, 0.958670520169331951,
                              0.910980297085]
        std_tnr_protected_list = [0.0013381003412159241, 0.039804760376243829, 0.00156165132873236814,
                                  0.0012096473014822554, 0.04332075278]
        tnr_non_protected_list = [0.95283444559215265, 0.973290589834092923, 0.94072027790575674677, 0.710980527646855,
                                  0.8610635112707]
        std_tnr_non_protected_list = [0.00151467651774054603, 0.01057896721547606195, 0.0010260785062740344,
                                      0.00927085604926498946, 0.05067714210]
    elif dataset == 'compass-gender':
        accuracy_list = [0.6469571807502843, 0.66722508525956803, 0.6672309208033346, 0.65260363774156877,
                         0.64550966275104]
        std_accuracy_list = [0.007792455261771766, 0.001603059032518792, 0.010757915548752078, 0.012350199687557593,
                             0.0208]
        balanced_accuracy_list = [0.63434455862629, 0.6567458512234059, 0.6600827079741186, 0.6501312277291022,
                                  .64886939]
        std_balanced_accuracy_list = [0.01082117593313684, 0.00711351617251441657, 0.0151502593227186553,
                                      0.012465191868153471, 0.016222]
        fairness_list = [0.0962694551709870803, 0.045651422896865717, 0.36047965671464255, 0.382563401185418984,
                         0.083480482744]
        std_fairness_list = [0.0410244441374238589, 0.0250394653748196136, 0.108798679197871552, 0.103817203788894951,
                             0.0326794]
        tpr_protected_list = [0.4513301570360016, 0.550033265273026526, 0.42509480150113111, 0.5516417052009246,
                              0.67064314]
        std_tpr_protected_list = [0.0420115192336582, 0.118528463560619144, 0.08924523659496632, 0.062093212799435625,
                                  0.0757678]
        tpr_non_protected_list = [0.4922756741347097, 0.57121508297727205, 0.63924458215773658, 0.7604757732810334,
                                  0.7120922]
        std_tpr_non_protected_list = [0.04393501872888887, 0.1296676198927925, 0.022886079474549104,
                                      0.02259978132857417, 0.0693820]
        tnr_protected_list = [0.75868457980288374, 0.7695401856952230119, 0.84698719163393386, 0.735589835780717275,
                              0.5812907277]
        std_tnr_protected_list = [0.03871587937598028, 0.1016389641808471606, 0.0475513476973961929,
                                  0.0524510550598840645, 0.08969849]
        tnr_non_protected_list = [0.7918500480234014, 0.761921714484253183, 0.6995443889322665558, .55006504997761336,
                                  0.5952709007]
        std_tnr_non_protected_list = [0.046849064790145126, 0.101449611884301484, 0.0251608182174372,
                                      0.031623538135080789, 0.09202423775]
    elif dataset == 'bank':
        accuracy_list = [0.90009499050094988, 0.899751424857514258, 0.90098790120987901, 0.877931806819318069,
                         0.8923307669]
        std_accuracy_list = [0.0011923676604366244, 0.0019968368708106071, 0.0050694166277808405, 0.006075196953787954,
                             0.006265161]
        balanced_accuracy_list = [0.65210860705745567, 0.65515041193539315, 0.68265309263554562, 0.7416725434153347,
                                  0.77355314]
        std_balanced_accuracy_list = [0.0049149868796822442, 0.0018187025211562281, 0.01010568728357864683,
                                      0.00532987182467402, 0.024169644419]

        fairness_list = [0.030409417988262151, 0.0321728691698796191, 0.1124338491850008172, 0.1145902230433248708,
                         0.03728204]
        std_fairness_list = [0.01831911437453038, 0.010819733007404186, 0.033629513836561771, 0.03714484624130022,
                             0.02184306287]
        tpr_protected_list = [0.34111771871163785, 0.341121579225188047, 0.3765180304227645969, 0.50867025641738457,
                              0.6262534]
        std_tpr_protected_list = [0.014701760130666241, 0.0259791705499161388, 0.0216088669221312787,
                                  0.0214143152400590156, 0.064571351]
        tpr_non_protected_list = [0.340052713669989998, 0.325166827206530015, 0.46514153412646789, 0.5916543043101094,
                                  0.607502842]
        std_tpr_non_protected_list = [0.0213184925292930135, 0.0562417411490916702, 0.02731227957465693647,
                                      0.03133287645748039, 0.063821916]
        tnr_protected_list = [0.97753569792411787, 0.972698784934158359, 0.972594590560276856, 0.9528659813645353,
                              0.9321964914]
        std_tnr_protected_list = [0.001578348457488543, 0.00929896500655757333, 0.0020801621407839662,
                                  0.00114711497242106588, 0.01398628956]
        tnr_non_protected_list = [0.97022120901047203, 0.976247568017577768, 0.948694648329272704, 0.92247093092757714,
                                  0.92008725]
        std_tnr_non_protected_list = [0.0022196508400848152, 0.01005286937213739, 0.00919912565390148657,
                                      0.0106487498149501307, 0.0179017613]
        ...
        std_tnr_non_protected_list = [0.00012111197845660435, 0.0002773489204307783, 0.0020289538389142094,
                                      0.0216364888]
